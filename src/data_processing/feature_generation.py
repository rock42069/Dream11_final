...
# # Initialize the class and call the methods
# jaishreeram = FeatureGeneration(mw_overall, mw_pw_profile,'Test')
# jaishreeram.make_all_features()
# out_file_path = os.path.abspath(os.path.join(current_dir,'..','..',"src",'data','processed','final_training_file_test.csv'))

# jaishreeram.mw_pw_profile.to_csv(out_file_path, index=False)
